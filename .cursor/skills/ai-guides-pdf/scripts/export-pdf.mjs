 ...
 *
 * Setup (skill-local, self-contained fonts):
 *   npm install --prefix .cursor/skills/ai-guides-pdf
 *   node .cursor/skills/ai-guides-pdf/scripts/export-pdf.mjs [input.md] [output.pdf]
 */
...
import { SKILL_DIR, buildFontFaceCss } from "./lib/fonts.mjs";
...
const CSS_FILE = path.join(SKILL_DIR, "assets/pdf-export.css");
